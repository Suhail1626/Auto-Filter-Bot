...
USERNAME = environ.get('USERNAME', 'https://telegram.me/BetterProfessor')
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002032875531'))
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/Z22.jpg')
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002032875531'))
